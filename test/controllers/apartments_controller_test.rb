...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { latitude: @apartment.latitude, longitude: @apartment.longitude, price: @apartment.price, surface: @apartment.surface } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { latitude: @apartment.latitude, longitude: @apartment.longitude, price: @apartment.price, surface: @apartment.surface } }
